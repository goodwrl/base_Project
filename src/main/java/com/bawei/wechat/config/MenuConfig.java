package com.bawei.wechat.config;
...
public class MenuConfig {
	...
	protected static WxMenu getMenu() {
	    ...
	    String toUrl = "http%3a%2f%2fweiqin.free.ngrok.cc%2fwechat%2fhtml%2findex.html";
	    String url="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx4804009da0455f2e&redirect_uri=" + toUrl + "&response_type=code&scope=snsapi_base&state=123#wechat_redirect";
	    button1.setUrl(url);
	...
	public static void main(String[] args) {
		MainConfig mainConfig = new MainConfig("wx4804009da0455f2e", "551cf72dd9ba222a1e8cf9ef7aa3db6f", "0bfcff1d3694aa654a0cfd95a95f2068", "aesKey");
		WxMpService wxMpService = mainConfig.wxMpService();
		try {
